...
public struct ChartLabelSettings {
    ...
    public init(font: UIFont = UIFont.systemFont(ofSize: 14), fontColor: UIColor = #colorLiteral(red: 0.4, green: 0.4274509804, blue: 0.5607843137, alpha: 1), rotation: CGFloat = 0, rotationKeep: ChartLabelDrawerRotationKeep = .center, shiftXOnRotation: Bool = true, textAlignment: ChartLabelTextAlignment = .default) {
        self.font = font
